...
export default function SubscriptionPage() {
  ...
  const targetColumn = "subscription";
  ...
  const handleRequestLatest = async () => {
    ...
    setRequesting(true);
    try {
      await viewModel.requestLatestSubscriptionAnalysisGet({
        info_db_no: infoDbNo,
        user_info: "user_info",
